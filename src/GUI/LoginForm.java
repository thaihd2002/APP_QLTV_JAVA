...
public class LoginForm extends JFrame {
	...
	public LoginForm() {
		...
		panel.add(btnNewButton);
                ...
                btnNewButton.setBackground(new Color(30, 144, 255)); // Màu xanh dương đậm
                btnNewButton.setForeground(Color.WHITE);
                btnNewButton.setBorderPainted(false); // Ẩn viền của nút
                btnNewButton.setFocusPainted(false); // Ẩn đường viền khi nút được chọn
                btnNewButton.addMouseListener(new java.awt.event.MouseAdapter() {
                     public void mouseEntered(java.awt.event.MouseEvent evt) {
                         btnNewButton.setBackground(new Color(70, 130, 180)); // Màu xanh dương nhạt khi hover
                            }

                      public void mouseExited(java.awt.event.MouseEvent evt) {
                          btnNewButton.setBackground(new Color(30, 144, 255)); // Trở lại màu xanh dương đậm khi thoát khỏi hover
                            }
                          });
				...
				for (TaiKhoan taiKhoan2 : taikhoan) {
					if (taiKhoan2.getUsername().trim().equals(txtUser.getText().trim())
						...
						if(MainFrame.isdangxuat) {
							new MainFrame(quyen).setVisible(true);
						}
						return;
					}
