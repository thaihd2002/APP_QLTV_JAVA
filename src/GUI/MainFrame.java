...
public class MainFrame extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MainFrame frame = new MainFrame(quyen);
	...
	public void menuleft() {
		...
		lblthuviensgu = new JLabel("Th\u01B0 Vi\u1EC7n UNETI");
		...
		lblTrangchu.setIcon(new ImageIcon("C:\\Users\\ASUS\\Pictures\\14-145167_home-icon-home-icon-png-green-removebg-preview.png"));
		...
		lblNewLabel_17.setIcon(new ImageIcon("img\\iconUNETI 3.png"));
		...
		btnTm_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				String timsach = txttimsach.getText();
				List<SachDTO> dssach = SachBus.gI().timsach(timsach);
		...
		btnTm_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String ma = txttimtacgia.getText();
				List<TacGiaDTO> dstg = TacGiaBUS.gI().timtacgia(ma);
		...
		btnTimnxb.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String ma = txttimnxb.getText();
				List<NhaXuatBan> dsnxb = NhaXuatBanBUS.gI().timnxb(ma);
				if (dsnxb != null) {
				...
				{
					JOptionPane.showMessageDialog(null, "Không tìm thấy Nhà Xuất Bản "+ma);
				}
		...
		btnTimphieumuon.setBounds(478, 327, 123, 47);
	...
	private void nhanvien() {
		...
		if(quyen==1) panel_2.setVisible(false);
	...
	private void docgia() {
		...
		btnTimkiemdocgia.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				String ma = txtTimkiemdocgia.getText();
				List<DocGia> dsdg = DocGiaBUS.gI().timdocgia(ma);
				if (dsdg != null) {
				...
				{
					JOptionPane.showMessageDialog(null, "Không tìm thấy Đọc Giả "+ma);
				}
			}
		});
...
//						System.out.println(tv);
	...
	private void pnsach() {
		...
		panel_8 = new JPanel();
		panel_8.setBounds(66, 77, 788, 273);
		pnSach.add(panel_8);
		panel_8.setLayout(null);

		JPanel panel = new JPanel();
		panel.setBounds(0, 0, 788, 273);
		panel_8.add(panel);
	...
	private void trangchu() {
		...
		lblNewLabel = new JLabel("CHÀO MỪNG BẠN ĐẾN VỚI THƯ VIỆN UNETI");
	...
	public void addEvent() {
		...
		btnthemphieumuon.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				PhieuMuon pm = new PhieuMuon(mapm, manv, madocgia, ngaymuon, tinhtrang);
