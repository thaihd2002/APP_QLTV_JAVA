...
public class PhieuMuonDAL {
	...
	public static int thempm(PhieuMuon ke) {
		int i = -1;
		String sql = "insert into phieumuon (mapm,manv,MaDocGia,NgayMuon,TinhTrang,Trangthai) values(?,?,?,?,?,?)";
		...
		try {
			...
			pstm.setInt(2, ke.getMaNV());
			pstm.setInt(3, ke.getMaDocGia());
			pstm.setString(4, ke.getNgayMuon());
			pstm.setString(5, ke.getTinhtrang());
			pstm.setInt(6, 1);
